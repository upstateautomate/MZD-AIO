...
ipc.on('update-err', (event) => {
  clearInterval(dll)
  dll = null
  $('#update-available').html('<a onclick="shell.openExternal(\'https://github.com/upstateautomate/MZD-AIO/releases\')" class="link">ERROR: CLICK HERE FOR UPDATE.</a>')
  snackbarstay(`<a onclick="shell.openExternal(\'https://github.com/upstateautomate/MZD-AIO/releases\')" class="link">UPDATE ERROR: CLICK HERE TO DOWNLOAD THE LATEST UPDATE.</a>`)
})
